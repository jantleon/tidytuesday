...
plot <- data %>% 
  ...
  ggplot() +
    ...
    xlab(NULL) +
    ylab(NULL) +
      labs(title = "<b>Number of <span style='color:red'>landline</span> and <span style='color:blue'>mobile</span> subscriptiones per 100 (1990-2017)",
         subtitle = "Mobile phone subscriptions shoot up worldwide since the end of the 90s",
